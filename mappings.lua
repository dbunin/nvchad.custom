...
M.general = {
  n = {
    ...
    -- jack-in
    ["<localleader>'"] = { "<cmd> Clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version \"1.0.0\"} cider/cider-nrepl {:mvn/version \"0.30.0\"}} :aliases {:cider/nrepl {:main-opts [\"-m\" \"nrepl.cmdline\" \"--middleware\" \"[cider.nrepl/cider-middleware]\"]}}}' -Mdev:repl:test:cider/nrepl <CR>", "Clojure jack-in" },
